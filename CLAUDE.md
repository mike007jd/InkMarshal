...
This project is indexed by GitNexus as **InkMarshal** (7661 symbols, 20666 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
