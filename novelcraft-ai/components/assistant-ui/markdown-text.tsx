...
import { type AnchorHTMLAttributes, type FC, type ImgHTMLAttributes, memo, useState } from "react";
import { CheckIcon, CopyIcon } from "lucide-react";

import { TooltipIconButton } from "@/components/assistant-ui/tooltip-icon-button";
import { renderSafeMarkdownLink } from "@/components/SafeMarkdown";
import { sanitizeMarkdownHref } from "@/lib/markdown-url";
import { cn } from "@/lib/utils";

export const assistantMarkdownSecurityComponents = {
  a: ({ className, ...props }: AnchorHTMLAttributes<HTMLAnchorElement>) =>
    renderSafeMarkdownLink(
      {
        ...props,
        className: cn(
  ...
  img: ({ alt }: ImgHTMLAttributes<HTMLImageElement>) => (alt ? <span>{alt}</span> : null),
};
...
const defaultComponents = memoizeMarkdownComponents({
  ...
  ...assistantMarkdownSecurityComponents,
