/**
 * Frozen already-distributed legacy schema-1 shape: current pre-status-column
 * table set including knowledge_vault_outbox. Do not edit.
 */
export const LEGACY_SCHEMA_1_DDL = `
